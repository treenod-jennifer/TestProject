...
public class ChatData
{
    ...
    */
    ...
    public string characterExpression_0 = "";
    ...
    public string characterExpression_1 = "";
...
public class ChatGameData : MonoBehaviour
{
    ...
    public Dictionary<string, string> _stringData = null; 
    void Awake()
    {
        if (transform.parent.parent.GetComponent<AreaBase>() != null)
            _stringData = transform.parent.parent.GetComponent<AreaBase>()._stringData;
    }

...
[CustomEditor(typeof(PresentBoxEvent), true)]
public class EditPresentBoxEvent: Editor
{
    protected PresentBoxEvent _target;

    protected void OnEnable()
    {
        wakeUpScene = PlayerPrefs.GetInt("EditPresentBoxEvent",0);
    }
    void ReAttach()
    {
        _target = target as PresentBoxEvent;
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (beforeWakeUpScene != wakeUpScene)
            PlayerPrefs.SetInt("EditPresentBoxEvent", wakeUpScene);

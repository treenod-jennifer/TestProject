...
[CustomEditor(typeof(UIReusableScrollView))]
public class UIReusableScrollViewEditor : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        NGUIEditorTools.DrawProperty("Scroll Start Position Offset", serializedObject, "startPositionOffset");
        NGUIEditorTools.DrawProperty("Scroll Start Position", serializedObject, "startPosition");

...
[CustomEditor(typeof(CapsuleGachaAreaBase), true)]
public class EditCapsuleGachaAreaBase : Editor
{
    protected CapsuleGachaAreaBase _target;

    protected void OnEnable()
    {
        wakeUpScene = PlayerPrefs.GetInt("EditCapsuleGachaAreaBase", 0);
    }
    void ReAttach()
    {
        _target = target as CapsuleGachaAreaBase;
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (beforeWakeUpScene != wakeUpScene)
            PlayerPrefs.SetInt("EditCapsuleGachaAreaBase", wakeUpScene);

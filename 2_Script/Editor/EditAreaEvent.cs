...
[CustomEditor(typeof(AreaEvent), true)]
public class EditAreaEvent : Editor
{
    protected AreaEvent _target;

    protected void OnEnable()
    {
        wakeUpScene = PlayerPrefs.GetInt("EditAreaEvent",0);
    }
    void ReAttach()
    {
        _target = target as AreaEvent;

...
[CustomEditor(typeof(MoleCatchEvent), true)]
public class EditMoleCatchEvent : Editor
{
    protected MoleCatchEvent _target;

    protected void OnEnable()
    {
        wakeUpScene = PlayerPrefs.GetInt("EditMoleCatchEvent", 0);
    }
    void ReAttach()
    {
        _target = target as MoleCatchEvent;
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (beforeWakeUpScene != wakeUpScene)
            PlayerPrefs.SetInt("EditMoleCatchEvent", wakeUpScene);

...
[CustomEditor(typeof(PokoFlowerEventAreaBase), true)]
public class EditPokoFlowerEventAreaBase: Editor
{
    protected PokoFlowerEventAreaBase _target;

    protected void OnEnable()
    {
        wakeUpScene = PlayerPrefs.GetInt("EditPokoFlowerEvent", 0);
    }
    void ReAttach()
    {
        _target = target as PokoFlowerEventAreaBase;
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (beforeWakeUpScene != wakeUpScene)
            PlayerPrefs.SetInt("EditPokoFlowerEvent", wakeUpScene);

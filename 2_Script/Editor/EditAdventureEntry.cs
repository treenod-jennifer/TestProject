...
[CustomEditor(typeof(AdventureEntry), true)]
public class EditAdventureEntry : Editor
{
    protected AdventureEntry _target;

    protected void OnEnable()
    {
        wakeUpScene = PlayerPrefs.GetInt("EditAdventureEntry", 0);
    }
    void ReAttach()
    {
        _target = target as AdventureEntry;
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (beforeWakeUpScene != wakeUpScene)
            PlayerPrefs.SetInt("EditAdventureEntry", wakeUpScene);

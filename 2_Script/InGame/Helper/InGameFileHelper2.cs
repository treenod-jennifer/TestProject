...
public class InGameFileHelper2 : MonoBehaviour
{
    ...
    public static IEnumerator WWW_Upload(string path, byte[] image = null, string gimmickString = "", string targetString = "", string modeString = "", string descriptionString = "", string author = "")
    {

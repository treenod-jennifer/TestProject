...
public class BlockLinker : MonoBehaviour {
    ...
    {
        ManagerUIAtlas.CheckAndApplyEventAtlas(linkerSprite);
        ManagerUIAtlas.CheckAndApplyEventAtlas(linkerSpriteFR);
        ManagerUIAtlas.CheckAndApplyEventAtlas(linkerSpriteRE);

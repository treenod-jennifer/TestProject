...
public class GrassFenceBlock : DecoBase, IDisturb
{
    public BlockDirection direction = BlockDirection.DOWN;
    public int fenceIndex = 0;
    
    public Board boardB;

    const string SpriteName = "grass_fence";
    ...
    {   
        ...
        {
            InGameEffectMaker.instance.MakeGrass(this.transform.position);
    ...
    public override void MakeFieldEffect()
    {
        if (bombFieldRoutine != null)
        {
            ...
            DOTween.Kill(effectBombFieldSprite.gameObject);
    ...
    public override void SetSprite()
    {
        ...
        uiSprite.spriteName = name + "_0" + lifeCount.ToString();

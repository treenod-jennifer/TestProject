...
{
    public GameObject pushCheck;
    public GameObject nightTimeCheck;
    public GameObject fullCloverCheck;
    public GameObject finishMissionCheck;
    public GameObject giftBoxCheck;
    public GameObject eventInfoCheck;
    
    public UILabel[] title;

    public UILabel pushText;
    public UILabel nightTimeText;
    public UILabel fullCloverText;
    public UILabel finishMissionText;
    public UILabel giftBoxText;

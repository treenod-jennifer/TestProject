...
public class InGameEffectMaker : MonoSingletonOnlyScene<InGameEffectMaker>
{
    ...
    public GameObject alphabetEventEffectObj;
    ...
    public GameObject FlyComboCountObj;

    public GameObject FlyAdventureTreasureObj;
    public GameObject FlyAdventurePotionHealObj;
    public GameObject FlyAdventurePotionSkillObj;

    //모험모드 동물 이펙트
    public GameObject[] AnimalEffectList;


    public GameObject EnemyLightingSkillHitEffectObj;
    public GameObject EnemyHeartSkillHitEffectObj;
    ...
    public GameObject animalSkill_Attack_Cast03Obj;
    public GameObject animalSkill_Heal_Cast01Obj;
    public GameObject animalSkill_Heal_Cast02Obj;
    public GameObject animalSkill_Heal_Target;
    public GameObject animalSkill_ButtonObj;
    public GameObject animalSkill_Attack_Target01obj;
    public GameObject animalSkill_Frozen_Cast01obj;
    public GameObject animalSkill_Frozen_Cast02obj;
    public GameObject animalSkill_InstallObject;
    public GameObject EnemySkill_Frozen_Hit01obj;
    public GameObject Skill_Button_Fullobj;
    ...
    public GameObject MakeAdventureEffect(Vector3 targetPos, string EffectName, float playTime = 5.0f)
    {
        GameObject obj = null;
        ...
        else if (EffectName == "EnemyHeartSkillHitEffect")
            obj = NGUITools.AddChild(GameUIManager.instance.Advance_Root, EnemyHeartSkillHitEffectObj);
        ...
        else if (EffectName == "EnemySkill_Frozen_Hit01")
            obj = NGUITools.AddChild(GameUIManager.instance.Advance_Root, EnemySkill_Frozen_Hit01obj);
        ...
        else if (EffectName == "animalSkill_Attack_Cast03")
            obj = NGUITools.AddChild(GameUIManager.instance.Advance_Root, animalSkill_Attack_Cast03Obj);
        ...
        else if(EffectName == "animalSkill_Heal_Target")
            obj = NGUITools.AddChild(GameUIManager.instance.Advance_Root, animalSkill_Heal_Target);
        else if (EffectName == "animalSkill_Button")
            obj = NGUITools.AddChild(GameUIManager.instance.Advance_Root, animalSkill_ButtonObj);
        else if(EffectName == "animalSkill_Attack_Target01")
            obj = NGUITools.AddChild(GameUIManager.instance.Advance_Root, animalSkill_Attack_Target01obj);
        else if(EffectName == "animalSkill_Frozen_Cast01")
            obj = NGUITools.AddChild(GameUIManager.instance.Advance_Root, animalSkill_Frozen_Cast01obj);
        else if (EffectName == "animalSkill_Frozen_Cast02")
            obj = NGUITools.AddChild(GameUIManager.instance.Advance_Root, animalSkill_Frozen_Cast02obj);
        else if (EffectName == "animalSkill_InstallObject")
            obj = NGUITools.AddChild(GameUIManager.instance.Advance_Root, animalSkill_InstallObject);
        ...
        if(playTime != Mathf.Infinity)
            StartCoroutine(DeleteEffect(obj, playTime));

        return obj;
    }

    private IEnumerator DeleteEffect(GameObject effect, float time)
    {
    ...
    public GameObject MakeAdventureSkillIconEffect(GameObject target, float playTime = 5.0f)
    {
        GameObject effect = NGUITools.AddChild(target, Skill_Button_Fullobj);
        effect.transform.localPosition = Vector3.zero;

        if (playTime != Mathf.Infinity)
            StartCoroutine(DeleteEffect(effect, playTime));
    ...
    {
        GameObject obj = NGUITools.AddChild(GameUIManager.instance.Advance_Root, FlyMakeBombObj);
        obj.transform.position = startPos;
        FlyMakeBomb flyMakeBomb = obj.GetComponent<FlyMakeBomb>();
        return flyMakeBomb;
    }

    public FlyTreasureBlock MakeFlyMakeAdventureTreasure(Vector3 startPos, string spriteName)
    {
        GameObject obj = NGUITools.AddChild(GameUIManager.instance.Advance_Root, FlyAdventureTreasureObj);
        obj.transform.position = startPos;
        FlyTreasureBlock flyTreasure = obj.GetComponent<FlyTreasureBlock>();
        flyTreasure.SetSprite(spriteName);
        return flyTreasure;
    }

    public FlyAdventurePotion_Heal MakeFlyMakeAdventurePotionHeal(Vector3 startPos)
    {
        GameObject obj = NGUITools.AddChild(GameUIManager.instance.Advance_Root, FlyAdventurePotionHealObj);
        obj.transform.position = startPos;
        FlyAdventurePotion_Heal flyTreasure = obj.GetComponent<FlyAdventurePotion_Heal>();
        return flyTreasure;
    }

    public FlyAdventurePotion_Skill MakeFlyMakeAdventurePotionSkill(Vector3 startPos)
    {
        GameObject obj = NGUITools.AddChild(GameUIManager.instance.Advance_Root, FlyAdventurePotionSkillObj);
        obj.transform.position = startPos;
        FlyAdventurePotion_Skill flyTreasure = obj.GetComponent<FlyAdventurePotion_Skill>();
        return flyTreasure;
    }
    ...
    public GameObject MakeAlphabetEventEffect(Vector3 startPos, Vector3 endPos, string imageName, bool isNormalBlock = true, Action endAction = null)
    {
        GameObject obj = NGUITools.AddChild(GameUIManager.instance.Effect_Root, alphabetEventEffectObj);
        obj.transform.position = startPos;

        FlyAlphabetEventEffect alphabetEffect = obj.GetComponent<FlyAlphabetEventEffect>();
        alphabetEffect.InitEffect(startPos, endPos, imageName, isNormalBlock, endAction);
        return obj;
    }
    ...
    public GameObject MakeComboBonus(Vector3 startPos, string score, float delay = 0)
    {
        GameObject obj = NGUITools.AddChild(GameUIManager.instance.Advance_Root, ScoreObj);
        obj.transform.position = startPos;

        BlockScore tempScore = obj.GetComponent<BlockScore>();
        tempScore.initScore(startPos, score, delay);
        tempScore._textScore.color = Color.yellow;
        tempScore._textScore.depth = 30;
    ...
    public GameObject MakeCombo(Vector3 startPos, string score)
    {
        ...
        BlockScore tempScore = obj.GetComponent<BlockScore>();
        tempScore.initScore(startPos, score, 0);
        tempScore._textScore.color = Color.yellow;
    ...
    {
        GameObject obj = NGUITools.AddChild(GameUIManager.instance.Advance_Root, FlyComboCountObj);
        obj.transform.position = startPos;

        FlyComboCount tempScore = obj.GetComponent<FlyComboCount>();
    ...
    public GameObject MakeRainbowLine3(Vector3 endPos, BlockBase tempBlock, int tempPangIndex, BlockBombType bombType = BlockBombType.NONE, bool isAdventrueRainbowXRainbow = false, bool hasCarpet = false)
    {
        ...
        if (GameManager.gameMode == GameMode.ADVENTURE && isAdventrueRainbowXRainbow)
            rainbowline.AdventureRainbowXRainbow = true;
    ...
    public GameObject MakeRainbowLineAdventureBomb(Vector3 startPos, Vector3 endPos, BlockBase tempBlock, int tempPangIndex, BlockBombType bombType = BlockBombType.NONE, float waitTimer = 0)
    {
        GameObject obj = NGUITools.AddChild(GameUIManager.instance.Effect_Root, RainbowObj2);
        Effect_RainbowLine rainbowline = obj.GetComponent<Effect_RainbowLine>();
        ...
        float distanceRainbow = (4 * 78) / Vector3.Distance(tempBlock.transform.localPosition, Vector3.zero);

        rainbowline.speed = rainbowline.speed * distanceRainbow;

        // if (tempBlockB.indexX < 6) rainbowline.curveDir = 1;
        // if (tempBlockB.indexX <= tempBlock.indexX && tempBlockB.indexY != tempBlock.indexY) rainbowline._transform.localScale = new Vector3(1, -1, 1);
        if (5 <= tempBlock.indexX && 5 == tempBlock.indexY) rainbowline._transform.localScale = new Vector3(1, -1, 1);
    ...
    */
    ...
    public FlyBlock MakeFlyBlockAdventure(Vector3 startPo, string name)
    {
        GameObject obj = NGUITools.AddChild(GameUIManager.instance.Advance_Root, flyBlockObj);
        FlyBlock block = obj.GetComponent<FlyBlock>();
        block.initBlock(startPo, name);
    ...
    public GameObject MakeEffectFlySimpleColorChangeEffect(Vector3 sPos, BlockColorType colorType)
    {
        var colorChangeObj = GameUIManager.instance.Effect_Root.AddChild(flyColorChangeObj).GetComponent<FlyColorChangeEffect>();
        colorChangeObj.transform.localPosition = sPos + GameUIManager.instance.groundAnchor.transform.localPosition;
        colorChangeObj.transform.rotation      = Quaternion.identity;
        colorChangeObj.InitSimpleEffect(colorType);
        return colorChangeObj.gameObject;
    }
    ...
    */
    ...
    public FlyCoin MakeFlyCoinAdventureBoss(Vector3 startPos, int count)
    {
        GameObject obj = NGUITools.AddChild(GameUIManager.instance.Advanture_Effect_Root, flyCoinObj);
        obj.transform.position = startPos;
        ...
        //시작위치 랜덤넣기
        int randCount = GameManager.instance.GetIngameRandom(0, 10);
        if (randCount > 5) flyTarget.dirBoss = -1;

        flyTarget.distBoss += (float)(randCount * 0.075f);
        flyTarget.speedRatio *= (float)(1 + randCount * 0.1f);
        flyTarget.endPos = GameUIManager.instance.adventureCoinLabel.transform.position;
        flyTarget.AdventureBossCoin = true;
    ...
    public Effect_Line MakeEffectLine(Vector3 startPos, EEffectBombLine tempType, bool largeBomb = false, bool crossBomb = false, int arrowDepth = 0, float opacity = 1f)
    {
        ...
        GameObject Root_GameObj = GameUIManager.instance.Effect_Root;
        if (GameManager.gameMode == GameMode.ADVENTURE)
            Root_GameObj = GameUIManager.instance.Advanture_Effect_Root;
        ...
        if (!largeBomb)
        {
            ...
            {
                effectA = NGUITools.AddChild(Root_GameObj, LineEffectLeftObj).GetComponent<Effect_Line>();
                effectA.arrowDepth = arrowDepth;
                effectA.crossLine = crossBomb;
            }
            else
            {
                effectA = NGUITools.AddChild(Root_GameObj, LineEffectRightObj).GetComponent<Effect_Line>();
                effectA.arrowDepth = arrowDepth;
                effectA.crossLine = crossBomb;
            }
        }
        else
        {
            if (tempType == EEffectBombLine.eHLeft || tempType == EEffectBombLine.eVDown)
            {
                effectA = NGUITools.AddChild(Root_GameObj, LargeLineEffectLeftObj).GetComponent<Effect_Line>();
                effectA.arrowDepth = arrowDepth;
                effectA.crossLine = crossBomb;
            }
            else
            {
                effectA = NGUITools.AddChild(Root_GameObj, LargeLineEffectRightObj).GetComponent<Effect_Line>();
                effectA.arrowDepth = arrowDepth;
                effectA.crossLine = crossBomb;
            }
        }
    ...
    {
        GameObject obj = NGUITools.AddChild(GameUIManager.instance.Effect_Root, ManagerNoyBoostEvent.instance.NoyBoostPackIngame.NoySpineObj);
    ...
    {
        GameObject obj = NGUITools.AddChild(GameUIManager.instance.Effect_Root, ManagerNoyBoostEvent.instance.NoyBoostPackIngame.BombSpineObj);

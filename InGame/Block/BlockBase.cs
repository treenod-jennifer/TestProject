...
public class BlockBase : MonoBehaviour 
{
    ...
    bool RestTargetToMove()     //이동가능한지 체크 아래가 비었거나 포탈이거나
    {
        ...
        if (board[indexX, indexY].IsDecoDisturbBlock()) return false;
    ...
    public void AddSpecialEventSprite(bool hide = false, bool isMakeStartBoard = true)
    {
        ...
        specialEventSprite.Load(Global.gameImageDirectory, "IconEvent/", "sEventBlock_" + Global.specialEventIndex);

...
public class BlockWorldRankItem : BlockBase
{
    [SerializeField]
    ...
    private void Start()
    {
        /*if (ManagerWorldRanking.instance != null)
        {
            ...
            itemImage.atlas = worldRankingAtlas;
        }*/
    }
    ...
    public IEnumerator CoStartEffect()
    {
        ...
        itemImage.spriteName = "worldCollectItem";
        ...
        itemImage.spriteName = "worldgimmick_Item";
    ...
    private IEnumerator CoMakeEffect()
    {
        ...
        for (int i = 0; i < effectCnt; i++)
        {
            ...
            InGameEffectMaker.instance.MakeFlyWorldRankItem
    ...
    {
        GameUIManager.instance.CollectAction_WorldRankingItem(itemCnt);
    }
    ...
    {
        lifeCount = life;
        ManagerBlock.instance.AddWorldRank(this);
    }
